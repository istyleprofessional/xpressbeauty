  ...
  return (
    <div class="flex flex-col justify-center items-center pt-7 lg:pt-20">
      ...
      <div class="flex flex-row flex-wrap justify-center gap-20 p-10 items-center">
        <a href="/products/filterBrands/ANDIS/">
          <img
        ...
        <a href="/products/filterBrands/BABYLISSPRO/">
          <img
        ...
        <a href="/products/filterBrands/3VERSINCE/">
          <img
        ...
        <a href="/products/filterBrands/PHILTHYBLENDZ/">
          <img
        ...
        <a href="/products/filterBrands/John-Paul-Mitchell-Systems/">
          <img
        ...
        <a href="/products/filterBrands/L'Oreal-Professionnel/">
          <img
