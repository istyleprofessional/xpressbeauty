            ...
            <img
              ...
              onClick$={() => {
                ...
                if (imgs) {
                  imgs.setAttribute(
                    "src",
                    img.includes("http") ? img : img.replace(".", "")
                  );
                }
              ...
              class={`object-contain w-16 h-16 lg:w-24 ${
                i === 0 ? "border-2" : "opacity-50"
              } lg:h-24 m-1 cursor-pointer transition duration-300 ease-in-out imgs status-img-${i}`}
            />
          ))}
      </div>
    </div>
